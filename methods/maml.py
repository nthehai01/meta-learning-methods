...
class MAML:
    ...
    def __init__(
        ...
        self._meta_parameters = Backbone.get_network(
    ...
    def _inner_loop(self, images, labels, train):
        ...
        Returns:
            local_parameters (dict[str, Tensor]): adapted network parameters
    ...
    def _outer_step(self, task_batch, train):
        ...
        for task in task_batch:
            ...
            local_parameters, acc_support = self._inner_loop(images_support, labels_support, train)
            accuracies_support_batch.append(acc_support)

            loss, acc_query = self._classify_feats(images_query, labels_query, local_parameters)
